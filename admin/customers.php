...
<div class="content-wrapper">
    ...
    <section class="content">
     <p><btn class ="btn btn-info btn-sm" data-toggle="modal" data-target="#add_customer"><i class="fa fa-plus"> New</i></btn>
        ...
        <div class="modal fade" id="warningModal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-warning-close"
    ...
    <table id="example2"  class="table table-bordered table-striped nowrap" style="width:100%">
      ...
      <tbody>
       <?php
        ...
        <tr>
          <td><?php echo $sno++; ?></td>
          <td><img style="display:block; border-radius:50%" width="30px" height="auto" src='<?php echo "../uploads/".$row['user_image'] ?>'></td>
